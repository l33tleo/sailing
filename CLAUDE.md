...
- NoGoZoneAngle (default 50°): angle from wind where sail can't generate force
- CloseHauledForce (0.18): force at edge of no-go zone
- BeamReachForce (1.0): peak force at 90° — fastest point of sail
- BroadReachForce (0.5): force at ~135°
- RunningForce (0.22): force at 180° (dead downwind, drag only)
